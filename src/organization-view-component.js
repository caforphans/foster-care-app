          ...
          <div className="col-span-3 space-y-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <div className="text-sm text-gray-600 mb-3">
                Check categories to explore who is working in your community
              </div>
              <div className="space-y-2">
                ...
                <label className="flex items-center gap-2">
                  <input type="checkbox" defaultChecked className="rounded" />
                  <span className="bg-orange-200 px-2 py-1 rounded text-xs">
                    Government
                  </span>
                </label>
                <label className="flex items-center gap-2">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <div className="text-sm text-gray-600 mb-3">
                Check boxes to identify who is working in MTE's four impact
                areas
              </div>
              <div className="space-y-2">
                <label className="flex items-center gap-2">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <div className="text-sm text-gray-600 mb-3">
                Turn on collaborations to see how organizations work together
              </div>
              <div className="space-y-2">
                <label className="flex items-center gap-2">
                  <input type="checkbox" defaultChecked className="rounded" />
                  <span className="text-blue-600 text-xs">
                    View Connection Lines
                  </span>
                </label>
                <label className="flex items-center gap-2">
                  <input type="checkbox" defaultChecked className="rounded" />
              ...
              <div className="h-96 bg-blue-100 rounded-lg relative">
                ...
                <div className="absolute top-1/2 right-8 bg-white p-3 rounded-lg shadow-lg max-w-xs">
                  ...
                  <p className="text-xs text-gray-600 mb-2">
                    Supporting foster families through faith-based community
                    connections and practical assistance.
                  </p>
                </div>
              </div>
            </div>
              ...
              {organizations.map((org, idx) => (
                <div key={idx} className="bg-white rounded-lg shadow-sm p-4">
                  ...
                  <div className="space-y-1 text-xs">
                    <div>
                      <strong>Focus Areas:</strong> {org.areas.join(', ')}
                    </div>
                    <div>
                      <strong>Location:</strong> {org.county}
                    </div>
                    <div>
